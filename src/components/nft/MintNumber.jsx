...
import { GlobalURL, RECEIVER_ADDRESS, BASE_SEPOLIA_CONTRACT_ADDRESS } from "../../constants";
  ...
  const buynumber = async () => {
    ...
    try {
      ...
      const metadata = {
        ...
        description: "This NFT represents ownership of a phone number. This NFT is transfered from Sepolia to Base Sepolia",
        image: imageUrl,
      ...
      // Handle minting based on connection type
        ...
        //   receiver: BASE_SEPOLIA_CONTRACT_ADDRESS,
